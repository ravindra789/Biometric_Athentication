 ...
 */
public class BiometricManager extends BiometricManagerVersion23 {
    ...
    public void authenticate(@NonNull final BiometricCallback biometricCallback) {
        ...
        if(!BiometricUtils.isBiometricPermissionGranted(context)) {
            biometricCallback.onBiometricAuthenticationPermissionNotGranted();
            return;
        }

        if(!BiometricUtils.isBiometricHardwareSupported(context)) {
    ...
    public void cancelAuthentication(){
        if(BiometricUtils.isBiometricPromtEnabled()) {
    ...
    private void displayBiometricPrompt(final BiometricCallback biometricCallback) {
        new BiometricPrompt.Builder(context)
                ...
                .authenticate(mCancellationSignal, context.getMainExecutor(),
                        new BiometricCallbackVersion28Above(biometricCallback));
    }
